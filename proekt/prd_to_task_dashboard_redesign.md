...
## Входные данные
Давай обозначим переменные указаные в этом файле (например если PRD = PRD_dashboard_redesign.md то берем/ищем именно файл PRD_dashboard_redesign.md в текущей директории и используем его в промпте)

PRD = PRD_dashboard_redesign.md,
tasks = tasks_dashboard_redesign.json
progress = progress_dashboard_redesign.md

Прочитай файл PRD в текущей директории.

## Требования к выходному файлу tasks
...
6. Сгенерируй tasks в формате JSON
